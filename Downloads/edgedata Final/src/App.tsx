...
export default function App() {
  ...
  // Track scroll for Industry 5.0 start (white -> dark)
  ...
  return (
    ...
    >
      ...
      <main>
        ...
        <UniversalTranslator textColor={textColor} paragraphColor={paragraphColor} />
        <div id="industry40" ref={industry40Ref}>
        ...
        <div id="social-proof" ref={socialProofRef}>
