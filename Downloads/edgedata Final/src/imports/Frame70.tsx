import svgPaths from "./svg-kt38ryqpeq";
    ...
    <div className="h-[35px] relative shrink-0 w-[54px]">
      <div className="absolute inset-[-0.21%_0_-3.25%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 54 36.2121">
          <g id="Frame 55">
            <path d={svgPaths.p3e873560} fill="var(--fill-0, white)" id="Vector" />
            <path d={svgPaths.p3be67500} fill="var(--fill-0, white)" id="Vector_2" />
            <path d={svgPaths.p457500} fill="var(--fill-0, white)" id="Vector_3" />
            <path d={svgPaths.p2c448e30} fill="var(--fill-0, white)" id="Vector_4" />
...
function Frame3() {
  return (
    <div className="h-[37px] relative shrink-0 w-[95px]">
      <Asset />
      <Frame1 />
      <div className="absolute flex flex-col font-['Outfit:Bold',sans-serif] font-bold inset-[67.57%_0_-2.7%_67.37%] justify-center leading-[0] text-[14px] text-center text-white">
