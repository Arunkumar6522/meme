import svgPaths from "./svg-9i98agmtd5";
      ...
      <div className="absolute inset-[-0.21%_0_-3.25%_0]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 54 36.2121">
          <g id="Frame 55">
            ...
            <path d={svgPaths.p3a952800} fill="var(--fill-0, #414E58)" id="Vector_5" />
          </g>
        </svg>
      </div>
    </div>
  ...
  return (
    <div className="h-[17.645px] relative shrink-0 w-[85.502px]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 85.502 17.6453">
        <g id="Group">
          <path d={svgPaths.p10898a00} fill="var(--fill-0, #414E58)" id="Vector" />
          <path d={svgPaths.p22aec300} fill="var(--fill-0, #414E58)" id="Vector_2" />
          <path d={svgPaths.p13458580} fill="var(--fill-0, #414E58)" id="Vector_3" />
          <path d={svgPaths.p38c1cec0} fill="var(--fill-0, #414E58)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="absolute h-[14.099px] left-0 top-[22.51px] w-[65.32px]" data-name="Frame">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 65.3199 14.0993">
        <g id="Frame">
          <path d={svgPaths.pc33a500} fill="var(--fill-0, #414E58)" id="Vector" />
          <path d={svgPaths.p1446890} fill="var(--fill-0, #414E58)" id="Vector_2" />
          <path d={svgPaths.p3d927400} fill="var(--fill-0, #414E58)" id="Vector_3" />
          <path d={svgPaths.pb2e5780} fill="var(--fill-0, #414E58)" id="Vector_4" />
          <path d={svgPaths.p22f47f00} fill="var(--fill-0, #414E58)" id="Polygon 1" />
          <path d={svgPaths.p1c0c3e00} fill="var(--fill-0, #414E58)" id="Polygon 2" />
        </g>
      </svg>
    </div>
  );
